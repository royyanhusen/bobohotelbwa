                    ...
                    <div class="flex flex-col p-4 gap-4 rounded-lg border border-[#DCDFE6]">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col gap-[2px]">
                                <p class="font-semibold text-sm leading-[21px] text-[#4041DA]">{{ $hotel_booking->checkin_at->format('M d') }} - {{ $hotel_booking->checkout_at->format('M d, Y') }} ({{ $hotel_booking->total_days }} Night)</p>
